...
- The **CLI launcher** (`cli/`, package/bin still `9router` for installed-base compat) — a separate package that installs/starts the server and manages the tray. It has its own `package.json`, version, and build.
