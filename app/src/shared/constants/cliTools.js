...
export const CLI_TOOLS = {
  ...
  copilot: {
    ...
    color: "#1F6FEB",
    description: "GitHub Copilot in VS Code via ZRouter extension",
    configType: "guide",
...
# cs45 -> cc/claude-sonnet-4-5-20250929`,
  ...
  "grok-build": {
    ...
    notes: [
      {
        type: "info",
        text: "Grok Build uses ~/.grok/config.toml. ZRouter writes a [model.9router] custom model and sets it as the default.",
      },
      {
        type: "info",
