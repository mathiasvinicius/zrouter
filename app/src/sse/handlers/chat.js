...
export async function handleChat(request, clientRawRequest = null) {
  ...
  const { model: requestedModel, contextMarker } = stripModelContextMarker(body.model);
...
async function handleSingleModelChat(body, modelStr, clientRawRequest = null, request = null, apiKey = null, identityContext = null, profile = null) {
  ...
  if (!modelInfo.provider) {
    ...
    if (comboModels) {
      ...
      return handleComboChat({
        ...
        models: augmentedModels,
        handleSingleModel: withCapacityAdapterStripping(
          (b, m) => handleSingleModelChat(b, m, clientRawRequest, request, apiKey, identityContext, profile),
          adapterAdded
        ),
        log,
        comboName: modelStr,
  ...
  while (true) {
    ...
    const result = await handleChatCore({
      ...
      cacheControlMode: chatSettings.cacheControlMode,
