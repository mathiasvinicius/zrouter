...
import { getDefaultMemoryBackend } from "@/lib/identityMemory/index.js";
...
const PROTECTED_SETTING_KEYS = ["password", "mitmSudoEncrypted", "memoryBackend"];
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      enableRequestLogs,
      enableTranslator,
      memoryBackend: getDefaultMemoryBackend(),
...
export async function PATCH(request) {
  try {
    ...
    const { password, oidcClientSecret, ...safeSettings } = settings;
    safeSettings.oidcConfigured = !!(safeSettings.oidcIssuerUrl && safeSettings.oidcClientId && oidcClientSecret);
    safeSettings.memoryBackend = getDefaultMemoryBackend();
