---
name: zrouter-tts
description: Use para sintetizar voz pelo endpoint /v1/audio/speech do ZRouter, após verificar os modelos e vozes disponíveis nesta instalação.
---

# ZRouter — Text-to-Speech

Leia a [skill de entrada](../zrouter/SKILL.md) para endereço e autenticação. Descubra modelos e vozes antes de usar um exemplo abaixo.
