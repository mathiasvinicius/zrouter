---
name: zrouter-image
description: Use para gerar imagens pelo endpoint /v1/images/generations do ZRouter, após descobrir um modelo de imagem disponível nesta instalação.
---

# ZRouter — Image Generation

Leia a [skill de entrada](../zrouter/SKILL.md) para endereço e autenticação. Descubra o modelo antes de usar um exemplo abaixo.
