...
description: Use para buscar na web pelo endpoint /v1/search do ZRouter quando um provedor de busca estiver configurado e disponível.
---
...
Add the Xquik API key in ZRouter's provider settings. Xquik charges 1 credit per returned post. Continue a search by passing `pagination.next_cursor` as `provider_options.cursor`.
